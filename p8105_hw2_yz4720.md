...
```
    ...
    ##       year         month              dumpster  
    ##  Min.   :2014   Length:845         Min.   :  1  
    ##  1st Qu.:2017   Class :character   1st Qu.: 71  
    ##  Median :2019   Mode  :character   Median :162  
    ##  Mean   :2019                      Mean   :223  
...
The `trashwheel_df` dataset has 845 observations. The key variables
include the month and year of each trash dump, the weight of each trash
dump in tons, number of pieces of different types of trash, and the
number of homes whose electricity is provided by each trash dump. The
...
```
    ...
    ##  $ sex         : chr [1:97] "male" "male" "male" "male" ...
    ##  $ education   : num [1:97] 16 16 18 12 20 16 20 20 12 16 ...
    ##  $ apoe4       : chr [1:97] "carrier" "non-carrier" "non-carrier" "carrier" ...
...
the participant is a APOE4 carrier or not, and age at MCI onset.

Among all the participant, 97 developed MCI. The average baseline age is
65.6. The proportion of women in the study who are APOE4 carriers is
0.6521739
